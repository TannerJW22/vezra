...
export default function ThemeProvider({ children }: ThemeProviderProps) {
  const [value, setValue] = useState<Theme>({
    input: {
      base: "peer px-3 pt-1 mb-[18px] outline-none border border-zinc-300 w-[220px] h-[46px] hover:bg-light-100 focus:bg-light-100 active:bg-light-100 focus:border-b-2 focus:border-x-0 focus:border-t-0 focus:border-primary-500 appearance-none focus:outline-none",
      onDisable:
    ...
    singleSelect: {
      base: "relative peer z-0 px-3 pt-1 mb-[18px] outline-none border border-zinc-300 w-[152px] h-[46px] hover:bg-light-100 focus:border-none appearance-none focus:outline-none cursor-pointer",
    ...
    dateCalendar: {
      base: "peer z-0 px-3 pt-1 mb-[18px] outline-none border border-zinc-300 w-[144px] h-[46px] hover:bg-light-100 focus:border-none appearance-none focus:outline-none cursor-pointer",
